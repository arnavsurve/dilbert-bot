...
def saveImg():
    ...
    img.save(f'/Users/arnavsurve/Documents/compsci/Python/dilbert-scraper/images/{image_date_underscores}.png')

def uploadImage():
    # check if able to verify credentials, then upload image to twitter
    if twitter.verify_credentials():
        photo = open(f'/Users/arnavsurve/Documents/compsci/Python/dilbert-scraper/images/{image_date_underscores}.png', 'rb')
